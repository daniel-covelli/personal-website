  ...
  const projects = [
    {
      ...
      bullets: [],
      techStack: ['TypeScript', 'React Native', 'GraphQL', 'Apollo', 'PostgreSQL', 'Docker'],
      githubUrl: null,
      liveUrl: null,
    },
    {
      ...
      bullets: [],
      techStack: ['TypeScript', 'React', 'GraphQL', 'Apollo', 'PostgreSQL', 'Docker'],
    ...
    },
    {
      ...
      bullets: [],
      techStack: ['MongoDB', 'Express', 'React-Redux', 'Node.js'],
    ...
    },
    {
      ...
      bullets: [],
      techStack: ['Python', 'Xpath', 'Selenium'],
